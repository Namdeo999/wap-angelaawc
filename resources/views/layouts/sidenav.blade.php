...
<div class="sidebar">
    ...
    <div class="dropdown bg-light  pt-1 pb-1 ">
        <button class="btn btn-secondry btn-sm dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="{{asset('public/wa_assets/images/icons/user_active.png')}}" class="rounded-circle" alt="..."> Welcome - Admin / User
        </button>
        <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton2">
            <li class="nav-item">
                <a class="dropdown-item active" aria-current="page" href="{{url('logout')}}">Logout</a>
            </li>
        </ul>
    </div>
